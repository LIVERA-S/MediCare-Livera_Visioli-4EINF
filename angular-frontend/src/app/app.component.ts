...
export class AppComponent {
  ...
  find(medico : HTMLInputElement){
   let m = medico.value;
   this.dataFrame = this.http.get<Medic[]>("https://5000-liveras-mynameis-v98y0ry5ez5.ws-eu45.gitpod.io/" + "medic/" + m);
   this.dataFrame.subscribe(this.fati)
  }

  findd(nil : HTMLInputElement){
    let n = nil.value;
    this.dataFrame1 = this.http.get<Medic[]>("https://5000-liveras-mynameis-v98y0ry5ez5.ws-eu45.gitpod.io/" + "nil/" + n);
